...
3. LiDAR(PointCloud2)와 Camera(Image)를 ApproximateTimeSynchronizer로 `sync_slop` 이내 동기화
...
| 32 | Camera 미수신 |
| 33 | 양쪽 센서 모두 미수신 |
| 34 | 양쪽 수신되었으나 동기화 실패 (`sync_slop` 초과) |
...
| `sync_slop` | double | `0.1` | LiDAR/Camera stamp 동기화 허용 오차 (초) |
