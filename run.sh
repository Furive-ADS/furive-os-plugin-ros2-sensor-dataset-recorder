...
DATASET_DIR="${FURIVE_SENSOR_DATASET_RECORDER_DATASET_DIR:-/data/furive-os/ros2-sensor-dataset-recorder/dataset}"
...
mkdir -p "$CONFIG_DIR" "$DATASET_DIR"
